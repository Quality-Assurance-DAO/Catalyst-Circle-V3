...
* [Method for selecting Catalyst Technical Council](https://github.com/Catalyst-Circle/Catalyst-Prioritized-Problems/issues/59) – originally Kenric’s in CCv2, so was transferred to Nadia. Assigned to Nadia and Harris, and will stay in Backlog for now.
...
**Harris (14:43)** Originally the card was about how to appropriately reward Circle members, but then it turned into proposals that Dimitri submitted.\
**Nori (15:28)** The card says that Circle members should be paid more, and retroactively; and there was disagreement in Circle on that. So is it officially accepted by the Circle? Or is it only an individual proposal, and rejected as a Circle issue?\
...
* No blockers, except perhaps Danny and Marek’s workload, as they are busy working on the voting app.

### **Harris (24:54)**

* [Initiating a code of conduct for Circle](https://github.com/Catalyst-Circle/Catalyst-Prioritized-Problems/issues/83) – Circle have discussed in Slack, but will need to deliberate further. There has not been a breakout meeting.  To be discussed later in this meeting.&#x20;
...
* I’ve been in various Twitter groups, correcting misconceptions, telling people Circle reps don’t have decision making power and don’t get preferential treatment on funding. Also worked with Nadia on Monday on developing Circle code of conduct.&#x20;
* On [anti-scammers initiative on social media](https://github.com/Catalyst-Circle/Catalyst-Prioritized-Problems/issues/45), we should discuss it as Circle; I am not aware what progress has been made until now.&#x20;
...
* Had a meeting to discuss the Prioritised Problems process with Tevo and Stephen. A helpful rubric on how to frame a problem; I used it to add a new problem to the board, [CA/vCA Community Needs to Prioritize and Solve F8 Sensed Issues for Fund 9](https://github.com/Catalyst-Circle/Catalyst-Prioritized-Problems/issues/87) – this comprises c. 33 issues; the sensing of them is done, and I’ve gone through the other 3 questions in the rubric for them as a group:\
...
* Blockers – waiting to discuss issues I’ve raised for discussion in later agenda items.                                                                                                      &#x20;
