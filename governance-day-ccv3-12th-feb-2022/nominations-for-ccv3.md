...
{% hint style="info" %}
**Experience of Project Catalyst – which roles have you fulfilled?**  Yes. I'm a co-author of the funded F4 project 'The Great Filter'. In addition, I am proposer of the F7 Catalyst proposal 'Researching CNFTs at Uni of Oxford' and voter.

**Experience in the functional group you seek to represent:**  Yes. I am one of the founding members of the ADA Café, a place where people and ideas connect. As part of the team, I'm hosting one of their curated Twitter Spaces (ADA café weekends) this means I'm in contact with many community members. I'm also a founding member of CNFT\_art, and built 'The Great Filter' together with two other SPOs. Most importantly, I am researching Cardano NFTs and blockchain as a new medium for art at the University of Oxford. This thesis should build the foundation for further research and will provide educational material. My goal eventually is to bridge Cardano with the humanities (a connection that barely exists!!).

**What do you see as the biggest concerns facing the functional group you hope to represent?** Communication and coordination within a decentralised system is inherently difficult and crucial at the same time. There is a huge number of tools (and data!) that are being created right now but very often, people struggle to find and connect with likeminded people to have an exchange or even build together. At the same time, the frustration is increasing, as people often compete instead to collaborate (which is not necessarily bad) but also don't find their audience. Imo, the main concern that needs be addressed is how to enable fruitful interactions, including the exchange of ideas, data and expertise within the community without becoming centralised.

**A key part of a Circle seat is to be a “sensor array" for opportunities/problems. How do you intend to engage with your functional group and bring existing and emerging issues in your community to the Circle?** I am already engaging with different areas of the community. As part of the ADA Café and Twitter Space host, but also because of my engagement in other working groups and circles (like the leadership academy or being an SPO), I get an impression of the needs of different groups and individuals. Being part of these groups (especially the ADA Café) also means being able to gather feedback from other people with a big community engagement.

**What key ideas or issues would you like to champion on behalf of your community?** Building an infrastructure that connects individuals and groups, makes them being heard, represented and that eventually serves their needs. Working on a decentralised ground doesn't necessarily exclude some sort of centralised infrastructure to avoid that the same efforts are made multiple times instead of once (same tools are built multiple times). Having an infrastructure in place that enables collaboration and exchange will improve the productivity, efficiency, but more importantly creativity and innovation in this space. This might (should?) even involve people from outside Cardano and the blockchain space.

**At the end of your term as a Circle Representative, what outcomes would represent success in your role?**  People know where to go to in order to get help for what they need.

**Is there anything else that you want voters to know as to why you would be a good fit for this seat on the Circle?**  My professional and personal life is characterised by its interdisciplinarity. I work 'in between', as a mediator between different groups, institutions, and subject areas; between academia, Cardano, art, technology – and I love it.
{% endhint %}
